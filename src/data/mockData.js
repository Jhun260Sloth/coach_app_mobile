...
export const COACHES = [
  {
    ...
    reelsCount: 6,
    packages: [
      { id: "p1", name: "1:1 Court Session", type: "1:1", duration: 60, mode: "In-person", price: 75, maxParticipants: 1, active: true },
      { id: "p2", name: "Junior Group (max 4)", type: "Group", duration: 60, mode: "In-person", price: 32, maxParticipants: 4, active: true },
      { id: "p3", name: "8-Week Term Block", type: "Term", duration: 60, mode: "In-person", price: 520, maxParticipants: 1, active: false },
      { id: "p4", name: "Family Tennis Session", type: "Family Sessions", duration: 60, mode: "In-person", price: 95, maxParticipants: 5, active: true },
    ],
    ...
    packages: [
      {
        ...
        price: 68, maxParticipants: 1, equipment: "Wear flat, closed-toe shoes", active: true,
      },
      {
        ...
        location: "Fitzroy Strength Studio", venue: "Fitzroy Strength Studio",
        price: 40, maxParticipants: 3, equipment: "", active: false,
      },
    ],
  ...
  },
  {
    ...
    reelsCount: 4,
    packages: [
      { id: "p1", name: "1:1 Poolside Session", type: "1:1", duration: 45, mode: "In-person", price: 60, maxParticipants: 1, active: true },
      { id: "p2", name: "Term Block (10 sessions)", type: "Term", duration: 45, mode: "In-person", price: 540, maxParticipants: 1, active: true },
    ],
  ...
  },
  {
    ...
    reelsCount: 9,
    packages: [
      { id: "p1", name: "1:1 Skills Session", type: "1:1", duration: 60, mode: "In-person", price: 70, maxParticipants: 1, active: true },
      { id: "p2", name: "Virtual Film Review", type: "1:1", duration: 30, mode: "Virtual", price: 35, maxParticipants: 1, active: true },
    ],
  ...
  },
  {
    ...
    reelsCount: 14,
    packages: [
      { id: "p1", name: "1:1 Private Session", type: "1:1", duration: 60, mode: "In-person", price: 55, maxParticipants: 1, active: true },
      { id: "p2", name: "Virtual Session", type: "1:1", duration: 45, mode: "Virtual", price: 38, maxParticipants: 1, active: true },
      { id: "p3", name: "4-Week Bundle", type: "Term", duration: 60, mode: "In-person", price: 200, maxParticipants: 1, active: true },
    ],
  ...
  },
  {
    ...
    reelsCount: 7,
    packages: [
      { id: "p1", name: "1:1 Coaching Session", type: "1:1", duration: 90, mode: "In-person", price: 85, maxParticipants: 1, active: true },
      { id: "p2", name: "Small Group (max 4)", type: "Group", duration: 90, mode: "In-person", price: 45, maxParticipants: 4, active: true },
    ],
